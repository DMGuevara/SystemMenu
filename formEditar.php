  ...
  <div class="row justify-content-md-center">
    ...
    <div class="col-md-5 mb-3">
      ...
      <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nombre" value="<?php echo $dataProducto['nombre']; ?>">
        </div>
        <div class="mb-3">
        ...
        <label for="Stock">Stock</label>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="stock" value="Habilitado" <?php echo $dataProducto['stock']==='Habilitado' ?  'checked' : '' ?> checked>
            <label class="form-check-label" for="stockH">
              Habilitado
            </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="stock" value="Deshabilitado" <?php echo $dataProducto['stock']==='Deshabilitado' ?  'checked' : '' ?>>
    ...
    <div class="col-md-5 mb-3">
        ...
        <br>
        <img src="fotosProductos/<?php echo $dataProducto['foto']; ?>" alt="foto perfil" class="card-img-top fotoPerfil">
    </div>
